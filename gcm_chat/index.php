...
<html>
    <head>
        <title>e-Health AI based APP and System for medical services</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="header">
            <label class="logo">SHAMI</label>
            <h2>Google Cloud Messaging</h2>
            <h2 class="small">e-Health AI based APP and System for Medical Services</h2>
        </div>
